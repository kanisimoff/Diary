...
namespace Diary.DbStore.MongoDb.Identity
{
    ...
    public class RoleStore<TRole, TContext, TUserRole, TRoleClaim> :
        ...
        where TRoleClaim : IdentityRoleClaim, IEntity, new()
    {
        /// <summary>
        ...
        public virtual async Task<IdentityResult> CreateAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await RolesContext.InsertOneAsync(role, null, cancellationToken);
        ...
        public virtual async Task<IdentityResult> UpdateAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await RolesContext.ReplaceOneAsync(r=> r.Id == role.Id, role, cancellationToken: cancellationToken);
            return IdentityResult.Success;
        }
        ...
        public virtual async Task<IdentityResult> DeleteAsync(TRole role, CancellationToken cancellationToken = default)
        {
            ...
            await RolesContext.DeleteOneAsync(r=> r.Id == role.Id, cancellationToken);
            return IdentityResult.Success;
        }
        ...
        public async virtual Task<IList<Claim>> GetClaimsAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return RoleClaims.AsQueryable().Where(rc => rc.RoleId.Equals(role.Id)).Select(c => new Claim(c.ClaimType, c.ClaimValue)).ToList();
        }
        ...
        public virtual async Task AddClaimAsync(TRole role, Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await RoleClaims.InsertOneAsync(CreateRoleClaim(role, claim), cancellationToken: cancellationToken);
        }
        ...
        public virtual async Task RemoveClaimAsync(TRole role, Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await RoleClaims.DeleteManyAsync(rc => rc.RoleId.Equals(role.Id) && rc.ClaimValue == claim.Value && rc.ClaimType == claim.Type, cancellationToken);
        }

        /// <summary>
        /// A navigation property for the roles the store contains.
        /// </summary>
        public virtual IQueryable<TRole> Roles => Context.Set<TRole>().Result.AsQueryable();

        public IMongoCollection<TRole> RolesContext => Context.Set<TRole>().Result;

        private IMongoCollection<TRoleClaim> RoleClaims => Context.Set<TRoleClaim>().Result;
